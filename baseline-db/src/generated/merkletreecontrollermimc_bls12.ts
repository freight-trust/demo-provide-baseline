...
export interface MerkleTreeControllerMiMC_BLS12NewLeafEventArgs
...
export interface MerkleTreeControllerMiMC_BLS12NewLeavesEventArgs
  extends DecodedLogArgs {
...
export class MerkleTreeControllerMiMC_BLS12Contract extends BaseContract {
  ...
  public getFunctionSignature(methodName: string): string {
    ...
    const methodAbi = MerkleTreeControllerMiMC_BLS12Contract.ABI()[
      index
  ...
  public async getLogsAsync<
    ArgsType extends MerkleTreeControllerMiMC_BLS12EventArgs
  >(
    eventName: MerkleTreeControllerMiMC_BLS12Events,
  ...
  constructor(
    ...
    deployedBytecode:
      | string
      | undefined = MerkleTreeControllerMiMC_BLS12Contract.deployedBytecode
  ) {
    super(
