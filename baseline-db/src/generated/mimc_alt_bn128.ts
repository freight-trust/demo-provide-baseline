...
export class MiMC_ALT_BN128Contract extends BaseContract {
  /**
   * @ignore
   */
  ...
  public getFunctionSignature(methodName: string): string {
    ...
    const methodAbi = MiMC_ALT_BN128Contract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
