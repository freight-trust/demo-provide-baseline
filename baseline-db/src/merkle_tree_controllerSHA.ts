...
export type MerkleTreeControllerSHAEventArgs =
  | MerkleTreeControllerSHANewLeafEventArgs
...
export class MerkleTreeControllerSHAContract extends BaseContract {
  /**
   * @ignore
   */
  ...
  public getFunctionSignature(methodName: string): string {
    ...
    const methodAbi = MerkleTreeControllerSHAContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
  ...
  /**
   * Subscribe to an event type emitted by the MerkleTreeControllerSHA contract.
   * @param eventName The MerkleTreeControllerSHA contract event you would like to subscribe to.
   ...
   */
  public subscribe<ArgsType extends MerkleTreeControllerSHAEventArgs>(
